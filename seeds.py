...
def seed_subjects():
    subjects = [
        ('Дискретна математика', randint(1, NUMBER_OF_TEACHERS)),
        ('Англійська мова', randint(1, NUMBER_OF_TEACHERS)),
        ('Теорія ймовірності та математична статистика', randint(1, NUMBER_OF_TEACHERS)),
        ('Економіка', randint(1, NUMBER_OF_TEACHERS)),
        ('Філософія', randint(1, NUMBER_OF_TEACHERS)),
        ('Інженерна та компютерна графіка', randint(1, NUMBER_OF_TEACHERS)),
